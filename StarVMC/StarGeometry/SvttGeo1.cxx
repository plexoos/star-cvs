#include "SvttGeo1.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       SvttGeo1::SvttGeo1()     
         : AgModule("SvttGeo1","  is the SVT geometry for STAR ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
    ...
    // ----------------------------------------------------------------------- geoctr
       void SvttGeo1::ConstructGeometry( const Char_t *dummy )     
       {        
             ///@addtogroup SvttGeo1_revision        
             ///@{           
             ...
             ///@{           
                   ...
                   /// svtl . layer = 1; //  layer number            
                   svtl . radius = 6.37+0.015; //  layer radius (center of wafer position)            
                   /// svtl . radius = 6.37+0.015; //  layer radius (center of wafer position)            
             ...
             ///@{           
                   ...
                   /// svtl . layer = 2; //  layer number            
                   svtl . radius = 7.38+0.015; //  layer radius            
                   /// svtl . radius = 7.38+0.015; //  layer radius            
                   //           
                   svtl.fill();           
             ///@}        
             ...
             ///@{           
                   ...
                   /// svtl . layer = 3; //  layer number            
                   svtl . radius = 10.38+0.015; //  layer radius            
                   /// svtl . radius = 10.38+0.015; //  layer radius            
             ...
             ///@{           
                   ...
                   /// svtl . layer = 4; //  layer number            
                   svtl . radius = 11.27+0.015; //  layer radius            
                   /// svtl . radius = 11.27+0.015; //  layer radius            
                   //           
                   svtl.fill();           
             ///@}        
             ...
             ///@{           
                   ...
                   /// svtl . layer = 5; //  layer number            
                   svtl . radius = 14.19+0.015; //  layer radius            
                   /// svtl . radius = 14.19+0.015; //  layer radius            
             ...
             ///@{           
                   ...
                   /// svtl . layer = 6; //  layer number            
                   svtl . radius = 15.13+0.015; //  layer radius            
                   /// svtl . radius = 15.13+0.015; //  layer radius            
                   //           
                   svtl.fill();           
             ///@}        
