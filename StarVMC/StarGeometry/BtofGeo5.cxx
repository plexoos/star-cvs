#include "BtofGeo5.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       BtofGeo5::BtofGeo5()     
         : AgModule("BtofGeo5"," is the Geometry of Barrel Trigger / Time Of Flight system  ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
          ...
          {         
                ...
                ///@{           
                      ...
                      if ( (btog.choice==11) )           
                      {              
                            choice=btog.choice+1    ;// run viii, 2 trays in west;              
                      }           
          ...
          {         
                ...
                ///@{           
                      ...
                      {              
                            ...
                            if ( (choice==12&&is==btog.posit4(4)) )              
                            {                 
                                  tof=7 ;//// run-8 (5 tofr8 trays);                 
                            }              
                            if ( (choice==12&&is==btog.posit4(5)) )              
                            {                 
                                  tof=7 ;//// run-8 (5 tofr8 trays);                 
                            }              
    ...
    // ----------------------------------------------------------------------- geoctr
       void BtofGeo5::ConstructGeometry( const Char_t *dummy )     
       {        
             ///@addtogroup BtofGeo5_revision        
             ///@{           
                   /// Author: W.J. Llope           
             ///@}        
             ///@addtogroup BtofGeo5_revision        
             ...
             ///@{           
                   ...
                   /// btog . posit3 = 33; //  TOFr tray position for choice 8,9,10 -> run-5,6,7 posn            
                   btog . posit4.at(0) = 17; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   ///btog . posit4.at(0) = 17; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   btog . posit4.at(1) = 18; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   ///btog . posit4.at(1) = 18; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   btog . posit4.at(2) = 19; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   ///btog . posit4.at(2) = 19; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   btog . posit4.at(3) = 37; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   ///btog . posit4.at(3) = 37; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   btog . posit4.at(4) = 39; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   ///btog . posit4.at(4) = 39; //  TOFr8 tray positions for choice 11,12 -> run 8 east and west trays            
                   //           
                   btog.fill();           
             ///@}        
             ...
             ///@{           
                   ...
                   ///mod7 . mrpca.at(31) = 32.; //  mrpc angles            
                   mod7 . x0offset = -4.32; //  Tray inner surface to the center -tray_Height/2+tray_WallThk            
                   /// mod7 . x0offset = -4.32; //  Tray inner surface to the center -tray_Height/2+tray_WallThk            
                   mod7 . hchgt = 0.466; //  HC->Height (r)            
                   /// mod7 . hchgt = 0.466; //  HC->Height (r)            
                   ...
                   /// mod7 . grlen = 7.4; //    GRaphite->Length            
                   mod7 . oghgt = 0.11; //  Outer Glass->Height            
                   /// mod7 . oghgt = 0.11; //  Outer Glass->Height            
                   mod7 . ogwid = 20.6; //   Outer Glass->Width            
                   /// mod7 . ogwid = 20.6; //   Outer Glass->Width            
