#include "BtofGeo4.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       BtofGeo4::BtofGeo4()     
         : AgModule("BtofGeo4"," is the Geometry of Barrel Trigger / Time Of Flight system  ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
    ...
    // ----------------------------------------------------------------------- geoctr
       void BtofGeo4::ConstructGeometry( const Char_t *dummy )     
       {        
             ///@addtogroup BtofGeo4_revision        
             ///@{           
                   /// Author: W.J. Llope           
             ///@}        
             ///@addtogroup BtofGeo4_revision        
             ...
             ///@{           
                   ...
                   /// btog . dz = 246.0; //  CTB/TOF tube half length            
                   btog . choice = 8; //  1=CTB, 2=Full-TOFp, 3=25% TOFp, 4=1 tray-TOFp,                                ;// 5=1 tray-TOFr, 6=Full-TOFr, 7=TOFp+TOFrp Run-IV                               ;// 8= Run-V 1 tray-TOFr           
                   /// btog . choice = 8; //  1=CTB, 2=Full-TOFp, 3=25% TOFp, 4=1 tray-TOFp,                                ;// 5=1 tray-TOFr, 6=Full-TOFr, 7=TOFp+TOFrp Run-IV                               ;// 8= Run-V 1 tray-TOFr           
                   ...
                   /// btog . posit2 = 23; //  TOFr tray position for choice 5 -> run-4 posn            
                   btog . posit3 = 33; //  TOFr tray position for choice 8 -> run-5 posn            
                   /// btog . posit3 = 33; //  TOFr tray position for choice 8 -> run-5 posn            
                   //           
                   btog.fill();           
             ///@}        
