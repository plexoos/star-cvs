#include "BtofGeo7.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@addtogroup BtofGeo7_vars     
          ///@{        
                Int_t i,is,choice,tof,iwid,igap,islat,year;        
                //        
                /// Int_t i,is,choice,tof,iwid,igap,islat,year        
          ///@}     
       BtofGeo7::BtofGeo7()     
         : AgModule("BtofGeo7"," is the Geometry of Barrel Trigger / Time Of Flight system  ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
          ...
          {         
                ...
                ///@{           
                      ...
                      {              
                            ...
                            {                 
                                  tof= 7 ;//// run-9:tofr8 tray (west);                 
                            }              
                            if ( (choice==12&&btog.posit5(is)==0) )              
                            {                 
                                  tof=-1 ;//// run-9: no tray (west);                 
                            }              
                            if ( (choice==-12&&btog.posit5(is+60)==1) )              
                            {                 
                                  tof= 7 ;//// run-9: tofr8 tray (east);                 
                            }              
                            if ( (choice==-12&&btog.posit5(is+60)==0) )              
                            {                 
                                  tof=-1 ;//// run-9: no tray (east);                 
                            }              
                            if ( choice==11 )              
                            {                 
                                  if ( is==btog.posit4(1) )                 
          ...
          {         
                ...
                ///@{           
                      ...
                      {  AgShape shape = AgShape("Bbox");              
                            shape     .Inherit( AgBlock::previous() );              
                            create     .SetParameters(shape);              
                            shape.par("dx")=mod7.sprmax;              
                            shape.par("dy")=mod7.igwid/2;              
                            shape.par("dz")=mod7.iglen/2;              
                            /// Shape Bbox dx=mod7.sprmax dy=mod7.igwid/2 dz=mod7.iglen/2               
                            _same_shape &= _stacker->SearchVolume( shape, _attribute );              
                            _shape = shape;              
    ...
    // ----------------------------------------------------------------------- geoctr
       void BtofGeo7::ConstructGeometry( const Char_t *dummy )     
       {        
             ///@addtogroup BtofGeo7_revision        
             ///@{           
                   /// Author: W.J. Llope           
             ///@}        
             ///@addtogroup BtofGeo7_revision        
