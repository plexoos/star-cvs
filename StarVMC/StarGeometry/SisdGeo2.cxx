#include "SisdGeo2.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       SisdGeo2::SisdGeo2()     
         : AgModule("SisdGeo2","  is the Silicon Strip Detector ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
    ...
    // ----------------------------------------------------------------------- geoctr
       void SisdGeo2::ConstructGeometry( const Char_t *dummy )     
       {        
             ///@addtogroup SisdGeo2_revision        
             ///@{           
                   /// Author: Lilian Martin, Joerg Reinnarth, Maxim Potekhin           
             ///@}        
             ///@addtogroup SisdGeo2_revision        
             ///@{           
                   /// Created:  27 Oct 04            
             ...
             ///@{           
                   ...
                   /// sfjp . ssrs_rmin = 28.0; //  Width of the side of the small rib (outside structure)            
                   sfjp . sslb_dx = 7.8; //  Linking box (sector to the cone)            
                   /// sfjp . sslb_dx = 7.8; //  Linking box (sector to the cone)            
                   sfjp . sslb_px = 19.1; //  X-Position = Y-Position of the linking box            
                   /// sfjp . sslb_px = 19.1; //  X-Position = Y-Position of the linking box            
                   sfjp . sslb_dy = 7.3; //  Linking box (sector to the cone)            
                   /// sfjp . sslb_dy = 7.3; //  Linking box (sector to the cone)            
                   sfjp . sslb_dz = 2.5; //  Linking box (sector to the cone)            
                   /// sfjp . sslb_dz = 2.5; //  Linking box (sector to the cone)            
                   ...
                   /// sfjp . sfaa_pz3 = 0.02; //  3. z-=Position of the A128C chips            
                   sfjp . sfsd_dx = 3.75; //  Dx of the strip detector            
                   /// sfjp . sfsd_dx = 3.75; //  Dx of the strip detector            
                   sfjp . sfsd_dy = 0.015; //  Dy of the strip detector            
                   /// sfjp . sfsd_dy = 0.015; //  Dy of the strip detector            
                   sfjp . sfsd_dz = 2.1; //  Dz of the strip detector            
                   /// sfjp . sfsd_dz = 2.1; //  Dz of the strip detector            
