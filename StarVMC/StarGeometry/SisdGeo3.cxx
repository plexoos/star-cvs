#include "SisdGeo3.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       SisdGeo3::SisdGeo3()     
         : AgModule("SisdGeo3","  is the Silicon Strip Detector ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
    ...
    // ----------------------------------------------------------------------- geoctr
       void SisdGeo3::ConstructGeometry( const Char_t *dummy )     
       {        
             ///@addtogroup SisdGeo3_revision        
             ///@{           
