#include "SvttGeo3.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       SvttGeo3::SvttGeo3()     
         : AgModule("SvttGeo3","  is the SVT geometry for STAR: corrected and without SSD ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
    ...
    // ----------------------------------------------------------------------- geoctr
       void SvttGeo3::ConstructGeometry()     
       {        
             ///@addtogroup SvttGeo3_revision        
             ///@{           
