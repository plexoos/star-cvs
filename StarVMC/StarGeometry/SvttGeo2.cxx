#include "SvttGeo2.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       SvttGeo2::SvttGeo2()     
         : AgModule("SvttGeo2","  is the SVT geometry for STAR: corrected and augmented ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
                ...
                ///@{           
                      ...
                      {              
                            { AgPlacement place = AgPlacement("SOUR","SOUM");                 
                                  ...
                                  place.TranslateX(cos(shield_phi(i_phi)*3.1415926/180.0)*(soup.rout-soup.dr/2.0));                 
                                  /// Translate x = cos(shield_phi(i_phi)*3.1415926/180.0)*(soup.rout-soup.dr/2.0)                 
                                  place.TranslateY(sin(shield_phi(i_phi)*3.1415926/180.0)*(soup.rout-soup.dr/2.0));                 
                                  /// Translate y = sin(shield_phi(i_phi)*3.1415926/180.0)*(soup.rout-soup.dr/2.0)                 
                                  place.TranslateZ(0.0);                 
                                  /// Translate z = 0.0                 
          ...
          {         
                ...
                ///@{           
                      ...
                      a=3.1415*(scbp.rmin1*AgPower<Int_t>(2)+scbp.rmin2*AgPower<Int_t>(2))*sqrt(1+sq);           
          ...
          {         
                ...
                ///@{           
                      ...
                      a=3.1415*(sfep.rmin1*AgPower<Int_t>(2)+sfep.rmin2*AgPower<Int_t>(2))*sqrt(1+sq);           
                ...
                ///@{           
                      ...
                      {              
                            ...
                            { AgPlacement place = AgPlacement("SFLM","SFMO");                 
                                  ...
                                  place.TranslateX(-(sfpa.rad*sin(ang)+(dthk*sin(ang+radtilt))/2));                 
                                  /// Translate x = -(sfpa.rad*sin(ang)+(dthk*sin(ang+radtilt))/2)                 
                                  place.TranslateY((sfpa.rad*cos(ang)+(dthk*cos(ang+radtilt))/2));                 
                                  /// Translate y = (sfpa.rad*cos(ang)+(dthk*cos(ang+radtilt))/2)                 
                                  place.TranslateZ(0);                 
                                  /// Translate z = 0                 
                                  place.AlphaZ((180.*ang/pi)+sfpa.tilt);                 
                                  /// Rotate: AlphaZ = (180.*ang/pi)+sfpa.tilt                 
                                  /// G3 Reference: thetax = 90                 
                                  /// G3 Reference: phix = 0                 
                                  /// G3 Reference: thetay = 90                 
                                  /// G3 Reference: phiy = 90                 
    ...
    // ----------------------------------------------------------------------- geoctr
       ...
       {        
             ...
             ///@{           
                   ...
                   /// sfpa . version = 1; //  geometry version            
                   sfpa . rmin = 22.0; //  mother rmin            
                   /// sfpa . rmin = 22.0; //  mother rmin            
                   sfpa . rmax = 28.0; //  mother rmax            
                   /// sfpa . rmax = 28.0; //  mother rmax            
             ...
             ///@{           
                   ...
                   /// ssld . sseplen = 55.4; //  separation shield cylinder, half length            
                   ssld . soutrinn = 28; //  outer shield cylinder, inner radius            
                   /// ssld . soutrinn = 28; //  outer shield cylinder, inner radius            
                   ssld . soutrout = 28.02; //  outer shield cylinder, outer radius            
                   /// ssld . soutrout = 28.02; //  outer shield cylinder, outer radius            
