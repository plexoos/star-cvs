#include "TpceGeo2.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       TpceGeo2::TpceGeo2()     
         : AgModule("TpceGeo2","  is the updated TPC ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
          ...
          {         
                ...
                ///@{           
                      ...
                      {              
                            hpla = -tecw.height/2+tecw.z(1)-tecw.dz(1)/2+trov.offcrdio ;//first pl;              
          ...
          {         
                ...
                ///@{           
                      ...
                      {              
                            if ( trov.nhp(i_nhp)>0 )              
                            {                 
                                  hpla = -tecw.gapheit/2+radoff+tecw.z(1)-tecw.dz(1)/2+trov.offcrdio ;//first pl;                 
                                  zvalue = hpla+4.0*(i_nhp-1);                 
    ...
    // ----------------------------------------------------------------------- geoctr
       void TpceGeo2::ConstructGeometry( const Char_t *dummy )     
       {        
             ///@addtogroup TpceGeo2_revision        
             ///@{           
             ...
             ///@{           
                   ...
                   ///trov . nhp.at(15) = 6; // no of holes/plane            
                   trov . hx.at(0) =   0.0; //  x of holes            
                   ///trov . hx.at(0) =   0.0; //  x of holes            
                   trov . hx.at(1) =    0.0; //  x of holes            
                   ///trov . hx.at(1) =    0.0; //  x of holes            
                   trov . hx.at(2) =     0.0; //  x of holes            
                   ///trov . hx.at(2) =     0.0; //  x of holes            
                   trov . hx.at(3) =    0.0; //  x of holes            
                   ///trov . hx.at(3) =    0.0; //  x of holes            
                   trov . hx.at(4) =     0.0; //  x of holes            
                   ///trov . hx.at(4) =     0.0; //  x of holes            
                   trov . hx.at(5) =    0.0; //  x of holes            
                   ///trov . hx.at(5) =    0.0; //  x of holes            
                   trov . hx.at(6) =  0.0; //  x of holes            
                   ///trov . hx.at(6) =  0.0; //  x of holes            
                   trov . hx.at(7) =  0.0; //  x of holes            
                   ///trov . hx.at(7) =  0.0; //  x of holes            
                   trov . hx.at(8) =  0.0; //  x of holes            
                   ///trov . hx.at(8) =  0.0; //  x of holes            
                   trov . hx.at(9) =                                       0.0; //  x of holes            
                   ///trov . hx.at(9) =                                       0.0; //  x of holes            
                   trov . hx.at(10) =    0.0; //  x of holes            
                   ///trov . hx.at(10) =    0.0; //  x of holes            
                   trov . hx.at(11) =     0.0; //  x of holes            
                   ///trov . hx.at(11) =     0.0; //  x of holes            
                   trov . hx.at(12) =    0.0; //  x of holes            
                   ///trov . hx.at(12) =    0.0; //  x of holes            
                   trov . hx.at(13) =     0.0; //  x of holes            
                   ///trov . hx.at(13) =     0.0; //  x of holes            
                   trov . hx.at(14) =  -5.17; //  x of holes            
                   ///trov . hx.at(14) =  -5.17; //  x of holes            
                   trov . hx.at(15) =  5.17; //  x of holes            
                   ///trov . hx.at(15) =  5.17; //  x of holes            
                   trov . hx.at(16) = 0.0; //  x of holes            
                   ///trov . hx.at(16) = 0.0; //  x of holes            
                   trov . hx.at(17) =  0.0; //  x of holes            
                   ///trov . hx.at(17) =  0.0; //  x of holes            
                   trov . hx.at(18) =                                      -6.21; //  x of holes            
                   ///trov . hx.at(18) =                                      -6.21; //  x of holes            
                   trov . hx.at(19) =   6.21; //  x of holes            
                   ///trov . hx.at(19) =   6.21; //  x of holes            
                   trov . hx.at(20) =    0.0; //  x of holes            
                   ///trov . hx.at(20) =    0.0; //  x of holes            
                   trov . hx.at(21) =    0.0; //  x of holes            
                   ///trov . hx.at(21) =    0.0; //  x of holes            
                   trov . hx.at(22) =     0.0; //  x of holes            
                   ///trov . hx.at(22) =     0.0; //  x of holes            
                   trov . hx.at(23) =    0.0; //  x of holes            
                   ///trov . hx.at(23) =    0.0; //  x of holes            
                   trov . hx.at(24) =  0.0; //  x of holes            
                   ///trov . hx.at(24) =  0.0; //  x of holes            
                   trov . hx.at(25) =  0.0; //  x of holes            
                   ///trov . hx.at(25) =  0.0; //  x of holes            
                   trov . hx.at(26) =  0.0; //  x of holes            
                   ///trov . hx.at(26) =  0.0; //  x of holes            
                   trov . hx.at(27) =                                      -7.79; //  x of holes            
                   ///trov . hx.at(27) =                                      -7.79; //  x of holes            
                   trov . hx.at(28) =   0.0; //  x of holes            
                   ///trov . hx.at(28) =   0.0; //  x of holes            
                   trov . hx.at(29) =     7.79; //  x of holes            
                   ///trov . hx.at(29) =     7.79; //  x of holes            
                   trov . hx.at(30) =   0.0; //  x of holes            
                   ///trov . hx.at(30) =   0.0; //  x of holes            
                   trov . hx.at(31) =     0.0; //  x of holes            
                   ///trov . hx.at(31) =     0.0; //  x of holes            
                   trov . hx.at(32) =    0.0; //  x of holes            
                   ///trov . hx.at(32) =    0.0; //  x of holes            
                   trov . hx.at(33) =  0.0; //  x of holes            
                   ///trov . hx.at(33) =  0.0; //  x of holes            
                   trov . hx.at(34) =  0.0; //  x of holes            
                   ///trov . hx.at(34) =  0.0; //  x of holes            
                   trov . hx.at(35) =  0.0; //  x of holes            
                   ///trov . hx.at(35) =  0.0; //  x of holes            
                   trov . hx.at(36) =                                      -8.34; //  x of holes            
                   ///trov . hx.at(36) =                                      -8.34; //  x of holes            
                   trov . hx.at(37) =   0.0; //  x of holes            
                   ///trov . hx.at(37) =   0.0; //  x of holes            
                   trov . hx.at(38) =     8.34; //  x of holes            
                   ///trov . hx.at(38) =     8.34; //  x of holes            
                   trov . hx.at(39) =   0.0; //  x of holes            
                   ///trov . hx.at(39) =   0.0; //  x of holes            
                   trov . hx.at(40) =     0.0; //  x of holes            
                   ///trov . hx.at(40) =     0.0; //  x of holes            
                   trov . hx.at(41) =    0.0; //  x of holes            
                   ///trov . hx.at(41) =    0.0; //  x of holes            
                   trov . hx.at(42) =  0.0; //  x of holes            
                   ///trov . hx.at(42) =  0.0; //  x of holes            
                   trov . hx.at(43) =  0.0; //  x of holes            
                   ///trov . hx.at(43) =  0.0; //  x of holes            
                   trov . hx.at(44) =  0.0; //  x of holes            
                   ///trov . hx.at(44) =  0.0; //  x of holes            
                   trov . hx.at(45) =                                      -9.38; //  x of holes            
                   ///trov . hx.at(45) =                                      -9.38; //  x of holes            
                   trov . hx.at(46) =   0.0; //  x of holes            
                   ///trov . hx.at(46) =   0.0; //  x of holes            
                   trov . hx.at(47) =     9.38; //  x of holes            
                   ///trov . hx.at(47) =     9.38; //  x of holes            
                   trov . hx.at(48) =   0.0; //  x of holes            
                   ///trov . hx.at(48) =   0.0; //  x of holes            
                   trov . hx.at(49) =     0.0; //  x of holes            
                   ///trov . hx.at(49) =     0.0; //  x of holes            
                   trov . hx.at(50) =    0.0; //  x of holes            
                   ///trov . hx.at(50) =    0.0; //  x of holes            
                   trov . hx.at(51) =  0.0; //  x of holes            
                   ///trov . hx.at(51) =  0.0; //  x of holes            
                   trov . hx.at(52) =  0.0; //  x of holes            
                   ///trov . hx.at(52) =  0.0; //  x of holes            
                   trov . hx.at(53) =  0.0; //  x of holes            
                   ///trov . hx.at(53) =  0.0; //  x of holes            
                   trov . hx.at(54) =                                     -10.50; //  x of holes            
                   ///trov . hx.at(54) =                                     -10.50; //  x of holes            
                   trov . hx.at(55) =   0.0; //  x of holes            
                   ///trov . hx.at(55) =   0.0; //  x of holes            
                   trov . hx.at(56) =    10.50; //  x of holes            
                   ///trov . hx.at(56) =    10.50; //  x of holes            
                   trov . hx.at(57) =   0.0; //  x of holes            
                   ///trov . hx.at(57) =   0.0; //  x of holes            
                   trov . hx.at(58) =     0.0; //  x of holes            
                   ///trov . hx.at(58) =     0.0; //  x of holes            
                   trov . hx.at(59) =    0.0; //  x of holes            
                   ///trov . hx.at(59) =    0.0; //  x of holes            
                   trov . hx.at(60) =  0.0; //  x of holes            
                   ///trov . hx.at(60) =  0.0; //  x of holes            
                   trov . hx.at(61) =  0.0; //  x of holes            
                   ///trov . hx.at(61) =  0.0; //  x of holes            
                   trov . hx.at(62) =  0.0; //  x of holes            
                   ///trov . hx.at(62) =  0.0; //  x of holes            
                   trov . hx.at(63) =                                     -11.97; //  x of holes            
                   ///trov . hx.at(63) =                                     -11.97; //  x of holes            
                   trov . hx.at(64) =  -4.05; //  x of holes            
                   ///trov . hx.at(64) =  -4.05; //  x of holes            
                   trov . hx.at(65) =    4.05; //  x of holes            
                   ///trov . hx.at(65) =    4.05; //  x of holes            
                   trov . hx.at(66) =  11.97; //  x of holes            
                   ///trov . hx.at(66) =  11.97; //  x of holes            
                   trov . hx.at(67) =    0.0; //  x of holes            
                   ///trov . hx.at(67) =    0.0; //  x of holes            
                   trov . hx.at(68) =    0.0; //  x of holes            
                   ///trov . hx.at(68) =    0.0; //  x of holes            
                   trov . hx.at(69) =  0.0; //  x of holes            
                   ///trov . hx.at(69) =  0.0; //  x of holes            
                   trov . hx.at(70) =  0.0; //  x of holes            
                   ///trov . hx.at(70) =  0.0; //  x of holes            
                   trov . hx.at(71) =  0.0; //  x of holes            
                   ///trov . hx.at(71) =  0.0; //  x of holes            
                   trov . hx.at(72) =                                     -12.70; //  x of holes            
                   ///trov . hx.at(72) =                                     -12.70; //  x of holes            
                   trov . hx.at(73) =  -4.32; //  x of holes            
                   ///trov . hx.at(73) =  -4.32; //  x of holes            
                   trov . hx.at(74) =    4.32; //  x of holes            
                   ///trov . hx.at(74) =    4.32; //  x of holes            
                   trov . hx.at(75) =  12.70; //  x of holes            
                   ///trov . hx.at(75) =  12.70; //  x of holes            
                   trov . hx.at(76) =    0.0; //  x of holes            
                   ///trov . hx.at(76) =    0.0; //  x of holes            
                   trov . hx.at(77) =    0.0; //  x of holes            
                   ///trov . hx.at(77) =    0.0; //  x of holes            
                   trov . hx.at(78) =  0.0; //  x of holes            
                   ///trov . hx.at(78) =  0.0; //  x of holes            
                   trov . hx.at(79) =  0.0; //  x of holes            
                   ///trov . hx.at(79) =  0.0; //  x of holes            
                   trov . hx.at(80) =  0.0; //  x of holes            
                   ///trov . hx.at(80) =  0.0; //  x of holes            
                   trov . hx.at(81) =                                     -13.70; //  x of holes            
                   ///trov . hx.at(81) =                                     -13.70; //  x of holes            
                   trov . hx.at(82) =  -4.63; //  x of holes            
                   ///trov . hx.at(82) =  -4.63; //  x of holes            
                   trov . hx.at(83) =    4.63; //  x of holes            
                   ///trov . hx.at(83) =    4.63; //  x of holes            
                   trov . hx.at(84) =  13.70; //  x of holes            
                   ///trov . hx.at(84) =  13.70; //  x of holes            
                   trov . hx.at(85) =    0.0; //  x of holes            
                   ///trov . hx.at(85) =    0.0; //  x of holes            
                   trov . hx.at(86) =    0.0; //  x of holes            
                   ///trov . hx.at(86) =    0.0; //  x of holes            
                   trov . hx.at(87) =  0.0; //  x of holes            
                   ///trov . hx.at(87) =  0.0; //  x of holes            
                   trov . hx.at(88) =  0.0; //  x of holes            
                   ///trov . hx.at(88) =  0.0; //  x of holes            
                   trov . hx.at(89) =  0.0; //  x of holes            
                   ///trov . hx.at(89) =  0.0; //  x of holes            
                   trov . hx.at(90) =                                     -14.67; //  x of holes            
                   ///trov . hx.at(90) =                                     -14.67; //  x of holes            
                   trov . hx.at(91) =  -4.98; //  x of holes            
                   ///trov . hx.at(91) =  -4.98; //  x of holes            
                   trov . hx.at(92) =    4.98; //  x of holes            
                   ///trov . hx.at(92) =    4.98; //  x of holes            
                   trov . hx.at(93) =  14.67; //  x of holes            
                   ///trov . hx.at(93) =  14.67; //  x of holes            
                   trov . hx.at(94) =    0.0; //  x of holes            
                   ///trov . hx.at(94) =    0.0; //  x of holes            
                   trov . hx.at(95) =    0.0; //  x of holes            
                   ///trov . hx.at(95) =    0.0; //  x of holes            
                   trov . hx.at(96) =  0.0; //  x of holes            
                   ///trov . hx.at(96) =  0.0; //  x of holes            
                   trov . hx.at(97) =  0.0; //  x of holes            
                   ///trov . hx.at(97) =  0.0; //  x of holes            
                   trov . hx.at(98) =  0.0; //  x of holes            
                   ///trov . hx.at(98) =  0.0; //  x of holes            
                   trov . hx.at(99) =                                     -15.86; //  x of holes            
                   ///trov . hx.at(99) =                                     -15.86; //  x of holes            
                   trov . hx.at(100) =  -7.91; //  x of holes            
                   ///trov . hx.at(100) =  -7.91; //  x of holes            
                   trov . hx.at(101) =    0.0; //  x of holes            
                   ///trov . hx.at(101) =    0.0; //  x of holes            
                   trov . hx.at(102) =    7.91; //  x of holes            
                   ///trov . hx.at(102) =    7.91; //  x of holes            
                   trov . hx.at(103) =   15.86; //  x of holes            
                   ///trov . hx.at(103) =   15.86; //  x of holes            
                   trov . hx.at(104) =   0.0; //  x of holes            
                   ///trov . hx.at(104) =   0.0; //  x of holes            
                   trov . hx.at(105) =  0.0; //  x of holes            
                   ///trov . hx.at(105) =  0.0; //  x of holes            
                   trov . hx.at(106) =  0.0; //  x of holes            
                   ///trov . hx.at(106) =  0.0; //  x of holes            
                   trov . hx.at(107) =  0.0; //  x of holes            
                   ///trov . hx.at(107) =  0.0; //  x of holes            
                   trov . hx.at(108) =                                     -16.95; //  x of holes            
                   ///trov . hx.at(108) =                                     -16.95; //  x of holes            
                   trov . hx.at(109) =  16.95; //  x of holes            
                   ///trov . hx.at(109) =  16.95; //  x of holes            
                   trov . hx.at(110) =    0.0; //  x of holes            
                   ///trov . hx.at(110) =    0.0; //  x of holes            
                   trov . hx.at(111) =    0.0; //  x of holes            
                   ///trov . hx.at(111) =    0.0; //  x of holes            
                   trov . hx.at(112) =     0.0; //  x of holes            
                   ///trov . hx.at(112) =     0.0; //  x of holes            
                   trov . hx.at(113) =    0.0; //  x of holes            
                   ///trov . hx.at(113) =    0.0; //  x of holes            
                   trov . hx.at(114) =  0.0; //  x of holes            
                   ///trov . hx.at(114) =  0.0; //  x of holes            
                   trov . hx.at(115) =  0.0; //  x of holes            
                   ///trov . hx.at(115) =  0.0; //  x of holes            
                   trov . hx.at(116) =  0.0; //  x of holes            
                   ///trov . hx.at(116) =  0.0; //  x of holes            
                   trov . hx.at(117) =                                     -18.37; //  x of holes            
                   ///trov . hx.at(117) =                                     -18.37; //  x of holes            
                   trov . hx.at(118) =  -8.99; //  x of holes            
                   ///trov . hx.at(118) =  -8.99; //  x of holes            
                   trov . hx.at(119) =    0.0; //  x of holes            
                   ///trov . hx.at(119) =    0.0; //  x of holes            
                   trov . hx.at(120) =    8.99; //  x of holes            
                   ///trov . hx.at(120) =    8.99; //  x of holes            
                   trov . hx.at(121) =   18.37; //  x of holes            
                   ///trov . hx.at(121) =   18.37; //  x of holes            
                   trov . hx.at(122) =   0.0; //  x of holes            
                   ///trov . hx.at(122) =   0.0; //  x of holes            
                   trov . hx.at(123) =  0.0; //  x of holes            
                   ///trov . hx.at(123) =  0.0; //  x of holes            
                   trov . hx.at(124) =  0.0; //  x of holes            
                   ///trov . hx.at(124) =  0.0; //  x of holes            
                   trov . hx.at(125) =  0.0; //  x of holes            
                   ///trov . hx.at(125) =  0.0; //  x of holes            
                   trov . hx.at(126) =                                     -19.11; //  x of holes            
                   ///trov . hx.at(126) =                                     -19.11; //  x of holes            
                   trov . hx.at(127) =  -9.76; //  x of holes            
                   ///trov . hx.at(127) =  -9.76; //  x of holes            
                   trov . hx.at(128) =    0.0; //  x of holes            
                   ///trov . hx.at(128) =    0.0; //  x of holes            
                   trov . hx.at(129) =    9.76; //  x of holes            
                   ///trov . hx.at(129) =    9.76; //  x of holes            
                   trov . hx.at(130) =   19.11; //  x of holes            
                   ///trov . hx.at(130) =   19.11; //  x of holes            
                   trov . hx.at(131) =   0.0; //  x of holes            
                   ///trov . hx.at(131) =   0.0; //  x of holes            
                   trov . hx.at(132) =  0.0; //  x of holes            
                   ///trov . hx.at(132) =  0.0; //  x of holes            
                   trov . hx.at(133) =  0.0; //  x of holes            
                   ///trov . hx.at(133) =  0.0; //  x of holes            
                   trov . hx.at(134) =  0.0; //  x of holes            
                   ///trov . hx.at(134) =  0.0; //  x of holes            
                   trov . hx.at(135) =                                     -20.15; //  x of holes            
                   ///trov . hx.at(135) =                                     -20.15; //  x of holes            
                   trov . hx.at(136) =  -12.08; //  x of holes            
                   ///trov . hx.at(136) =  -12.08; //  x of holes            
                   trov . hx.at(137) =  -4.05; //  x of holes            
                   ///trov . hx.at(137) =  -4.05; //  x of holes            
                   trov . hx.at(138) =   4.05; //  x of holes            
                   ///trov . hx.at(138) =   4.05; //  x of holes            
                   trov . hx.at(139) =   12.08; //  x of holes            
                   ///trov . hx.at(139) =   12.08; //  x of holes            
                   trov . hx.at(140) =  20.15; //  x of holes            
                   ///trov . hx.at(140) =  20.15; //  x of holes            
                   trov . hx.at(141) = 0.0; //  x of holes            
                   ///trov . hx.at(141) = 0.0; //  x of holes            
                   trov . hx.at(142) =  0.0; //  x of holes            
                   ///trov . hx.at(142) =  0.0; //  x of holes            
                   trov . hx.at(143) =  0.0; //  x of holes            
                   ///trov . hx.at(143) =  0.0; //  x of holes            
                   trov . offcrdio = -0.9; //  cards, first row inner sector            
                   /// trov . offcrdio = -0.9; //  cards, first row inner sector            
                   //           
                   trov.fill();           
             ///@}        
             ...
             ///@{           
                   ...
                   trov . sec = 2; //   outer            
                   /// trov . sec = 2; //   outer            
                   trov . nhp.at(0) = 6; //  number of holes in plane            
                   ///trov . nhp.at(0) = 6; //  number of holes in plane            
                   trov . nhp.at(1) = 7; //  number of holes in plane            
                   ///trov . nhp.at(1) = 7; //  number of holes in plane            
                   trov . nhp.at(2) = 7; //  number of holes in plane            
                   ///trov . nhp.at(2) = 7; //  number of holes in plane            
                   trov . nhp.at(3) = 7; //  number of holes in plane            
                   ///trov . nhp.at(3) = 7; //  number of holes in plane            
                   trov . nhp.at(4) = 7; //  number of holes in plane            
                   ///trov . nhp.at(4) = 7; //  number of holes in plane            
                   trov . nhp.at(5) = 7; //  number of holes in plane            
                   ///trov . nhp.at(5) = 7; //  number of holes in plane            
                   trov . nhp.at(6) = 8; //  number of holes in plane            
                   ///trov . nhp.at(6) = 8; //  number of holes in plane            
                   trov . nhp.at(7) = 8; //  number of holes in plane            
                   ///trov . nhp.at(7) = 8; //  number of holes in plane            
                   trov . nhp.at(8) = 8; //  number of holes in plane            
                   ///trov . nhp.at(8) = 8; //  number of holes in plane            
                   trov . nhp.at(9) = 8; //  number of holes in plane            
                   ///trov . nhp.at(9) = 8; //  number of holes in plane            
                   trov . nhp.at(10) = 8; //  number of holes in plane            
                   ///trov . nhp.at(10) = 8; //  number of holes in plane            
                   trov . nhp.at(11) = 9; //  number of holes in plane            
                   ///trov . nhp.at(11) = 9; //  number of holes in plane            
                   trov . nhp.at(12) = 9; //  number of holes in plane            
                   ///trov . nhp.at(12) = 9; //  number of holes in plane            
                   trov . nhp.at(13) = 9; //  number of holes in plane            
                   ///trov . nhp.at(13) = 9; //  number of holes in plane            
                   trov . nhp.at(14) = 9; //  number of holes in plane            
                   ///trov . nhp.at(14) = 9; //  number of holes in plane            
                   trov . nhp.at(15) = 9; //  number of holes in plane            
                   ///trov . nhp.at(15) = 9; //  number of holes in plane            
                   ...
                   trov . hx.at(8) =      0.0; // x of holes           
                   ///trov . hx.at(8) =      0.0; // x of holes           
                   trov . hx.at(9) =                                     -24.15; // x of holes           
                   ///trov . hx.at(9) =                                     -24.15; // x of holes           
                   trov . hx.at(10) =  -16.25; // x of holes           
                   ///trov . hx.at(10) =  -16.25; // x of holes           
                   trov . hx.at(11) =  -8.10; // x of holes           
                   ///trov . hx.at(11) =  -8.10; // x of holes           
                   trov . hx.at(12) =  0.00; // x of holes           
                   ///trov . hx.at(12) =  0.00; // x of holes           
                   trov . hx.at(13) =   8.10; // x of holes           
                   ///trov . hx.at(13) =   8.10; // x of holes           
                   trov . hx.at(14) =  16.25; // x of holes           
                   ///trov . hx.at(14) =  16.25; // x of holes           
                   trov . hx.at(15) =  24.15; // x of holes           
                   ///trov . hx.at(15) =  24.15; // x of holes           
                   trov . hx.at(16) =  0.0; // x of holes           
                   ///trov . hx.at(16) =  0.0; // x of holes           
                   trov . hx.at(17) =      0.0; // x of holes           
                   ///trov . hx.at(17) =      0.0; // x of holes           
                   trov . hx.at(18) =                                     -25.48; // x of holes           
                   ///trov . hx.at(18) =                                     -25.48; // x of holes           
                   trov . hx.at(19) =  -17.47 ; // x of holes           
                   ///trov . hx.at(19) =  -17.47 ; // x of holes           
                   trov . hx.at(20) = -8.71; // x of holes           
                   ///trov . hx.at(20) = -8.71; // x of holes           
                   trov . hx.at(21) =  0.00; // x of holes           
                   ///trov . hx.at(21) =  0.00; // x of holes           
                   trov . hx.at(22) =   8.71; // x of holes           
                   ///trov . hx.at(22) =   8.71; // x of holes           
                   trov . hx.at(23) =  17.47; // x of holes           
                   ///trov . hx.at(23) =  17.47; // x of holes           
                   trov . hx.at(24) =  25.48; // x of holes           
                   ///trov . hx.at(24) =  25.48; // x of holes           
                   trov . hx.at(25) =  0.0; // x of holes           
                   ///trov . hx.at(25) =  0.0; // x of holes           
                   trov . hx.at(26) =      0.0; // x of holes           
                   ///trov . hx.at(26) =      0.0; // x of holes           
                   trov . hx.at(27) =                                     -25.48; // x of holes           
                   ///trov . hx.at(27) =                                     -25.48; // x of holes           
                   trov . hx.at(28) =  -17.47; // x of holes           
                   ///trov . hx.at(28) =  -17.47; // x of holes           
                   trov . hx.at(29) =  -8.71; // x of holes           
                   ///trov . hx.at(29) =  -8.71; // x of holes           
                   trov . hx.at(30) =  0.00; // x of holes           
                   ///trov . hx.at(30) =  0.00; // x of holes           
                   trov . hx.at(31) =   8.71; // x of holes           
                   ///trov . hx.at(31) =   8.71; // x of holes           
                   trov . hx.at(32) =  17.47; // x of holes           
                   ///trov . hx.at(32) =  17.47; // x of holes           
                   trov . hx.at(33) =  25.48; // x of holes           
                   ///trov . hx.at(33) =  25.48; // x of holes           
                   trov . hx.at(34) =  0.0; // x of holes           
                   ///trov . hx.at(34) =  0.0; // x of holes           
                   trov . hx.at(35) =      0.0; // x of holes           
                   ///trov . hx.at(35) =      0.0; // x of holes           
                   trov . hx.at(36) =                                     -28.19; // x of holes           
                   ///trov . hx.at(36) =                                     -28.19; // x of holes           
                   trov . hx.at(37) =  -19.43; // x of holes           
                   ///trov . hx.at(37) =  -19.43; // x of holes           
                   trov . hx.at(38) = -10.81; // x of holes           
                   ///trov . hx.at(38) = -10.81; // x of holes           
                   trov . hx.at(39) =  0.00 ; // x of holes           
                   ///trov . hx.at(39) =  0.00 ; // x of holes           
                   trov . hx.at(40) = 10.81; // x of holes           
                   ///trov . hx.at(40) = 10.81; // x of holes           
                   trov . hx.at(41) =  19.43; // x of holes           
                   ///trov . hx.at(41) =  19.43; // x of holes           
                   trov . hx.at(42) =  28.19; // x of holes           
                   ///trov . hx.at(42) =  28.19; // x of holes           
                   trov . hx.at(43) =  0.0; // x of holes           
                   ///trov . hx.at(43) =  0.0; // x of holes           
                   trov . hx.at(44) =      0.0; // x of holes           
                   ...
                   ///trov . hx.at(45) =                                     -28.19; // x of holes           
                   trov . hx.at(46) =  -19.43; // x of holes           
                   ///trov . hx.at(46) =  -19.43; // x of holes           
                   trov . hx.at(47) = -10.81; // x of holes           
                   ///trov . hx.at(47) = -10.81; // x of holes           
                   trov . hx.at(48) =  0.00; // x of holes           
                   ///trov . hx.at(48) =  0.00; // x of holes           
                   trov . hx.at(49) =  10.81; // x of holes           
                   ///trov . hx.at(49) =  10.81; // x of holes           
                   trov . hx.at(50) =  19.43; // x of holes           
                   ///trov . hx.at(50) =  19.43; // x of holes           
                   trov . hx.at(51) =  28.19; // x of holes           
                   ///trov . hx.at(51) =  28.19; // x of holes           
                   trov . hx.at(52) =  0.0; // x of holes           
                   ///trov . hx.at(52) =  0.0; // x of holes           
                   trov . hx.at(53) =      0.0; // x of holes           
                   ...
                   ///trov . hx.at(54) =                                     -30.24; // x of holes           
                   trov . hx.at(55) =  -21.51; // x of holes           
                   ///trov . hx.at(55) =  -21.51; // x of holes           
                   trov . hx.at(56) = -13.54; // x of holes           
                   ///trov . hx.at(56) = -13.54; // x of holes           
                   trov . hx.at(57) = -5.37; // x of holes           
                   ///trov . hx.at(57) = -5.37; // x of holes           
                   trov . hx.at(58) =   5.37; // x of holes           
                   ///trov . hx.at(58) =   5.37; // x of holes           
                   trov . hx.at(59) =  13.54; // x of holes           
                   ///trov . hx.at(59) =  13.54; // x of holes           
                   trov . hx.at(60) =  21.51; // x of holes           
                   ///trov . hx.at(60) =  21.51; // x of holes           
                   trov . hx.at(61) =  30.24; // x of holes           
                   ///trov . hx.at(61) =  30.24; // x of holes           
                   trov . hx.at(62) =    0.0; // x of holes           
                   ///trov . hx.at(62) =    0.0; // x of holes           
                   trov . hx.at(63) =                                     -30.24; // x of holes           
                   ///trov . hx.at(63) =                                     -30.24; // x of holes           
                   trov . hx.at(64) =  -21.51; // x of holes           
                   ///trov . hx.at(64) =  -21.51; // x of holes           
                   trov . hx.at(65) = -13.54; // x of holes           
                   ///trov . hx.at(65) = -13.54; // x of holes           
                   trov . hx.at(66) = -5.37; // x of holes           
                   ///trov . hx.at(66) = -5.37; // x of holes           
                   trov . hx.at(67) =   5.37; // x of holes           
                   ///trov . hx.at(67) =   5.37; // x of holes           
                   trov . hx.at(68) =  13.54; // x of holes           
                   ///trov . hx.at(68) =  13.54; // x of holes           
                   trov . hx.at(69) =  21.51; // x of holes           
                   ///trov . hx.at(69) =  21.51; // x of holes           
                   trov . hx.at(70) =  30.24; // x of holes           
                   ///trov . hx.at(70) =  30.24; // x of holes           
                   trov . hx.at(71) =    0.0; // x of holes           
                   ///trov . hx.at(71) =    0.0; // x of holes           
                   trov . hx.at(72) =                                     -32.23; // x of holes           
                   ///trov . hx.at(72) =                                     -32.23; // x of holes           
                   trov . hx.at(73) =  -24.17; // x of holes           
                   ///trov . hx.at(73) =  -24.17; // x of holes           
                   trov . hx.at(74) = -16.09; // x of holes           
                   ///trov . hx.at(74) = -16.09; // x of holes           
                   trov . hx.at(75) = -5.42; // x of holes           
                   ///trov . hx.at(75) = -5.42; // x of holes           
                   trov . hx.at(76) =   5.42; // x of holes           
                   ///trov . hx.at(76) =   5.42; // x of holes           
                   trov . hx.at(77) =  16.09; // x of holes           
                   ///trov . hx.at(77) =  16.09; // x of holes           
                   trov . hx.at(78) =  24.17; // x of holes           
                   ///trov . hx.at(78) =  24.17; // x of holes           
                   trov . hx.at(79) =  32.23; // x of holes           
                   ///trov . hx.at(79) =  32.23; // x of holes           
                   trov . hx.at(80) =    0.0; // x of holes           
                   ///trov . hx.at(80) =    0.0; // x of holes           
                   trov . hx.at(81) =                                     -32.23; // x of holes           
                   ///trov . hx.at(81) =                                     -32.23; // x of holes           
                   trov . hx.at(82) =  -24.17; // x of holes           
                   ///trov . hx.at(82) =  -24.17; // x of holes           
                   trov . hx.at(83) = -16.09; // x of holes           
                   ///trov . hx.at(83) = -16.09; // x of holes           
                   trov . hx.at(84) = -5.42; // x of holes           
                   ///trov . hx.at(84) = -5.42; // x of holes           
                   trov . hx.at(85) =   5.42; // x of holes           
                   ///trov . hx.at(85) =   5.42; // x of holes           
                   trov . hx.at(86) =  16.09; // x of holes           
                   ///trov . hx.at(86) =  16.09; // x of holes           
                   trov . hx.at(87) =  24.17; // x of holes           
                   ///trov . hx.at(87) =  24.17; // x of holes           
                   trov . hx.at(88) =  32.23; // x of holes           
                   ///trov . hx.at(88) =  32.23; // x of holes           
                   trov . hx.at(89) =    0.0; // x of holes           
                   ///trov . hx.at(89) =    0.0; // x of holes           
                   trov . hx.at(90) =                                     -34.30; // x of holes           
                   ///trov . hx.at(90) =                                     -34.30; // x of holes           
                   trov . hx.at(91) =  -25.86; // x of holes           
                   ///trov . hx.at(91) =  -25.86; // x of holes           
                   trov . hx.at(92) = -16.14; // x of holes           
                   ///trov . hx.at(92) = -16.14; // x of holes           
                   trov . hx.at(93) = -8.10; // x of holes           
                   ///trov . hx.at(93) = -8.10; // x of holes           
                   trov . hx.at(94) =   8.10; // x of holes           
                   ///trov . hx.at(94) =   8.10; // x of holes           
                   trov . hx.at(95) =  16.14; // x of holes           
                   ///trov . hx.at(95) =  16.14; // x of holes           
                   trov . hx.at(96) =  25.86; // x of holes           
                   ///trov . hx.at(96) =  25.86; // x of holes           
                   trov . hx.at(97) =  34.30; // x of holes           
                   ///trov . hx.at(97) =  34.30; // x of holes           
                   trov . hx.at(98) =    0.0; // x of holes           
                   ///trov . hx.at(98) =    0.0; // x of holes           
                   trov . hx.at(99) =                                     -34.30; // x of holes           
                   ///trov . hx.at(99) =                                     -34.30; // x of holes           
                   trov . hx.at(100) =  -25.86; // x of holes           
                   ///trov . hx.at(100) =  -25.86; // x of holes           
                   trov . hx.at(101) = -16.14; // x of holes           
                   ///trov . hx.at(101) = -16.14; // x of holes           
                   trov . hx.at(102) = -8.10; // x of holes           
                   ///trov . hx.at(102) = -8.10; // x of holes           
                   trov . hx.at(103) =   0.00; // x of holes           
                   ///trov . hx.at(103) =   0.00; // x of holes           
                   trov . hx.at(104) =   8.10; // x of holes           
                   ///trov . hx.at(104) =   8.10; // x of holes           
                   trov . hx.at(105) =  16.14; // x of holes           
                   ///trov . hx.at(105) =  16.14; // x of holes           
                   trov . hx.at(106) =  25.86; // x of holes           
                   ///trov . hx.at(106) =  25.86; // x of holes           
                   trov . hx.at(107) =   34.30; // x of holes           
                   ///trov . hx.at(107) =   34.30; // x of holes           
                   trov . hx.at(108) =                                     -36.16; // x of holes           
                   ///trov . hx.at(108) =                                     -36.16; // x of holes           
                   trov . hx.at(109) =  -28.12; // x of holes           
                   ///trov . hx.at(109) =  -28.12; // x of holes           
                   trov . hx.at(110) = -16.14; // x of holes           
                   ///trov . hx.at(110) = -16.14; // x of holes           
                   trov . hx.at(111) = -8.10; // x of holes           
                   ///trov . hx.at(111) = -8.10; // x of holes           
                   trov . hx.at(112) =   0.00; // x of holes           
                   ///trov . hx.at(112) =   0.00; // x of holes           
                   trov . hx.at(113) =   8.10; // x of holes           
                   ///trov . hx.at(113) =   8.10; // x of holes           
                   trov . hx.at(114) =  16.14; // x of holes           
                   ///trov . hx.at(114) =  16.14; // x of holes           
                   trov . hx.at(115) =  28.12; // x of holes           
                   ///trov . hx.at(115) =  28.12; // x of holes           
                   trov . hx.at(116) =   36.16; // x of holes           
                   ///trov . hx.at(116) =   36.16; // x of holes           
                   trov . hx.at(117) =                                     -36.16; // x of holes           
                   ///trov . hx.at(117) =                                     -36.16; // x of holes           
                   trov . hx.at(118) =  -28.12; // x of holes           
                   ///trov . hx.at(118) =  -28.12; // x of holes           
                   trov . hx.at(119) = -16.14; // x of holes           
                   ///trov . hx.at(119) = -16.14; // x of holes           
                   trov . hx.at(120) = -8.10; // x of holes           
                   ///trov . hx.at(120) = -8.10; // x of holes           
                   trov . hx.at(121) =   0.00; // x of holes           
                   ///trov . hx.at(121) =   0.00; // x of holes           
                   trov . hx.at(122) =   8.10; // x of holes           
                   ///trov . hx.at(122) =   8.10; // x of holes           
                   trov . hx.at(123) =  16.14; // x of holes           
                   ///trov . hx.at(123) =  16.14; // x of holes           
                   trov . hx.at(124) =  28.12; // x of holes           
                   ///trov . hx.at(124) =  28.12; // x of holes           
                   trov . hx.at(125) =   36.16; // x of holes           
                   ///trov . hx.at(125) =   36.16; // x of holes           
                   trov . hx.at(126) =                                     -38.37; // x of holes           
                   ///trov . hx.at(126) =                                     -38.37; // x of holes           
                   trov . hx.at(127) =  -29.47; // x of holes           
                   ///trov . hx.at(127) =  -29.47; // x of holes           
                   trov . hx.at(128) = -20.76; // x of holes           
                   ///trov . hx.at(128) = -20.76; // x of holes           
                   trov . hx.at(129) = -10.61; // x of holes           
                   ///trov . hx.at(129) = -10.61; // x of holes           
                   trov . hx.at(130) =  0.00; // x of holes           
                   ///trov . hx.at(130) =  0.00; // x of holes           
                   trov . hx.at(131) =  10.61; // x of holes           
                   ///trov . hx.at(131) =  10.61; // x of holes           
                   trov . hx.at(132) =  20.76; // x of holes           
                   ///trov . hx.at(132) =  20.76; // x of holes           
                   trov . hx.at(133) =  29.47; // x of holes           
                   ///trov . hx.at(133) =  29.47; // x of holes           
                   trov . hx.at(134) =   38.37; // x of holes           
                   ///trov . hx.at(134) =   38.37; // x of holes           
                   trov . hx.at(135) =                                     -38.37; // x of holes           
                   ///trov . hx.at(135) =                                     -38.37; // x of holes           
                   trov . hx.at(136) =  -29.47; // x of holes           
                   ///trov . hx.at(136) =  -29.47; // x of holes           
                   trov . hx.at(137) = -20.76; // x of holes           
                   ///trov . hx.at(137) = -20.76; // x of holes           
                   trov . hx.at(138) = -10.61; // x of holes           
                   ///trov . hx.at(138) = -10.61; // x of holes           
                   trov . hx.at(139) =  0.00; // x of holes           
                   ///trov . hx.at(139) =  0.00; // x of holes           
                   trov . hx.at(140) =  10.61; // x of holes           
                   ///trov . hx.at(140) =  10.61; // x of holes           
                   trov . hx.at(141) =  20.76; // x of holes           
                   ///trov . hx.at(141) =  20.76; // x of holes           
                   trov . hx.at(142) =  29.47; // x of holes           
                   ///trov . hx.at(142) =  29.47; // x of holes           
                   trov . hx.at(143) =   38.37; // x of holes           
                   ///trov . hx.at(143) =   38.37; // x of holes           
                   trov . offcrdio = 0.0; //  card no special case            
                   /// trov . offcrdio = 0.0; //  card no special case            
                   //           
                   trov.fill();           
             ///@}        
