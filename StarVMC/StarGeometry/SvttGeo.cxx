#include "SvttGeo.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@addtogroup SvttGeo_vars     
          ///@{        
                Float_t xpos,ypos,zpos,clearence,rin,rou,elethk,tablen,radmax;        
                //        
                /// Float_t xpos,ypos,zpos,clearence,rin,rou,elethk,tablen,radmax        
          ///@}     
          ///@addtogroup SvttGeo_vars     
          ...
          ///@}     
       SvttGeo::SvttGeo()     
         : AgModule("SvttGeo","  is the SVT geometry for STAR ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
          ...
          {         
                ...
                ///@{           
                      ...
                      clearence=svtg.rsizemax-rsizemax;           
                      /// Material Air            
          ...
          {         
                ...
                ///@{           
                        ...
                        Bool_t _same_shape = true;           
                      /// Material SSDAMY            
                      {  AgMaterial mat = AgMaterial::CopyMaterial("Ssdamy");              
                            _material = mat;              
                      }           
    ...
    // ----------------------------------------------------------------------- geoctr
       void SvttGeo::ConstructGeometry( const Char_t *dummy )     
       {        
             ///@addtogroup SvttGeo_revision        
             ///@{           
             ...
             ///@{           
                   ...
                   /// swca . wafcarth = 0.0300; //  wafer carrier thickness             
                   swca . wafergap = 0.0; //  width of the inter-wafer gap                  
                   /// swca . wafergap = 0.0; //  width of the inter-wafer gap                  
             ...
             ///@{           
                   ...
                   /// ssup . roddist = 17.5; //  Distance of support rod od from beam axis             
                   ssup . rodid = 3.5; //  ID of Be support rods            
                   /// ssup . rodid = 3.5; //  ID of Be support rods            
                   ssup . rodod = 3.81; //  OD of Be support rods            
                   /// ssup . rodod = 3.81; //  OD of Be support rods            
             ...
             ///@{           
                   ...
                   /// svtl . layer = 1; //  layer number            
                   svtl . radius = 6.37+0.025; //  layer radius (center of wafer position)            
                   /// svtl . radius = 6.37+0.025; //  layer radius (center of wafer position)            
             ...
             ///@{           
                   ...
                   /// svtl . layer = 2; //  layer number            
                   svtl . radius = 7.38+0.025; //  layer radius            
                   /// svtl . radius = 7.38+0.025; //  layer radius            
                   //           
                   svtl.fill();           
             ///@}        
             ...
             ///@{           
                   ...
                   /// svtl . layer = 3; //  layer number            
                   svtl . radius = 10.38+0.025; //  layer radius            
                   /// svtl . radius = 10.38+0.025; //  layer radius            
             ...
             ///@{           
                   ...
                   /// svtl . layer = 4; //  layer number            
                   svtl . radius = 11.27+0.025; //  layer radius            
                   /// svtl . radius = 11.27+0.025; //  layer radius            
                   //           
                   svtl.fill();           
             ///@}        
             ...
             ///@{           
                   ...
                   /// svtl . layer = 5; //  layer number            
                   svtl . radius = 14.19+0.025; //  layer radius            
                   /// svtl . radius = 14.19+0.025; //  layer radius            
             ...
             ///@{           
                   ...
                   /// svtl . layer = 6; //  layer number            
                   svtl . radius = 15.13+0.025; //  layer radius            
                   /// svtl . radius = 15.13+0.025; //  layer radius            
                   //           
                   svtl.fill();           
             ///@}        
