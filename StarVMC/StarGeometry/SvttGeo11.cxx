#include "SvttGeo11.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       SvttGeo11::SvttGeo11()     
         : AgModule("SvttGeo11"," is evolution of svttgeo6 with carbon replacing Be as per Dave Lynn:                   Based on the SVTTGEO6 code ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
    ...
    // ----------------------------------------------------------------------- geoctr
       void SvttGeo11::ConstructGeometry()     
       {        
             ///@addtogroup SvttGeo11_revision        
             ///@{           
             ...
             ///@{           
                   ...
                   /// svtg . version = 2; //  geometry version            
                   svtg . config = 11; //  default one for svttgeo11.g            
                   /// svtg . config = 11; //  default one for svttgeo11.g            
             ...
             ///@{           
                   ...
                   /// swca . waferthk = 0.0300; //  wafer thickness            
                   swca . rohathk = 0.0750; //  05/02/08    | 0.2        ;// yf 05/01.08 0.0381     ;// Roha cell plus glue thickness             
                   /// swca . rohathk = 0.0750; //  05/02/08    | 0.2        ;// yf 05/01.08 0.0381     ;// Roha cell plus glue thickness             
             ...
             ///@{           
                   ...
                   /// selc . agpdthk = 0.0030; //  thickness of Ag-Pd conductor            
                   selc . glassthk = 0.2000; //  05/02/08  ;// 0.1500      ;// yf 05/01/08 0.0150      ;// thickness of glass insulator            
                   /// selc . glassthk = 0.2000; //  05/02/08  ;// 0.1500      ;// yf 05/01/08 0.0150      ;// thickness of glass insulator            
             ...
             ///@{           
                   ++ssld._index;           
                   ssld . version = 3; //  geometry version            
                   /// ssld . version = 3; //  geometry version            
                   ssld . sinrinn = 5; //  inner shield cylinder, inner radius            
                   /// ssld . sinrinn = 5; //  inner shield cylinder, inner radius            
                   ssld . sinrout = 5.008; //  inner shield cylinder, outer radius            
                   ...
                   ssld . sseplen = 55.4; //  separation shield cylinder, half length            
                   /// ssld . sseplen = 55.4; //  separation shield cylinder, half length            
                   ssld . soutrinn = 31.80; //  outer shield cylinder, inner radius            
                   /// ssld . soutrinn = 31.80; //  outer shield cylinder, inner radius            
                   ssld . soutrout = 31.82; //  outer shield cylinder, outer radius            
                   /// ssld . soutrout = 31.82; //  outer shield cylinder, outer radius            
                   ssld . soutlen = 65.4; //  outer shield cylinder, half length            
                   /// ssld . soutlen = 65.4; //  outer shield cylinder, half length            
                   ssld . almeshid = 9.7; //  Aluminum shield mesh inner diameter            
