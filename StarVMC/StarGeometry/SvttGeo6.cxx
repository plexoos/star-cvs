#include "SvttGeo6.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       SvttGeo6::SvttGeo6()     
         : AgModule("SvttGeo6","  is the SVT: corrected wafers and sensitive volumes ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
    ...
    // ----------------------------------------------------------------------- geoctr
       void SvttGeo6::ConstructGeometry()     
       {        
             ///@addtogroup SvttGeo6_revision        
             ///@{           
