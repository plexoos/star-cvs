#include "SvttGeo6.h"  
 ...
 {     
       ...
       {        
          ...
          {         
                ...
                ///@{           
                        ...
                        mCurrent = this;           
                        Bool_t _same_shape = true;           
                      /// Component Be	a=9	z=4	w=1.0           
                      /// Component O	a=16	z=8	w=1.0           
                      /// Mixture BeO dens=2.85           
                      {  AgMaterial &mix = AgMaterial::Get("Beo");              
                            mix.Component("Be",9,4,1.0);              
                            mix.Component("O",16,8,1.0);              
                            mix.par("dens")=2.85;              
                            mix.lock();              
                            _material = mix;              
                            _material.lock();              
          ...
          {         
                ...
                ///@{           
                        ...
                        mCurrent = this;           
                        Bool_t _same_shape = true;           
                      /// Component Ag	a=108	z=47	w=1.0           
                      /// Component Pd	a=106	z=46	w=1.0           
                      /// Mixture AgPd dens=11.25           
                      {  AgMaterial &mix = AgMaterial::Get("Agpd");              
                            mix.Component("Ag",108,47,1.0);              
                            mix.Component("Pd",106,46,1.0);              
                            mix.par("dens")=11.25;              
                            mix.lock();              
                            _material = mix;              
                            _material.lock();              
    ...
    // ----------------------------------------------------------------------- geoctr
       void SvttGeo6::ConstructGeometry( const Char_t *dummy )     
       {        
