...
/****************************************************************************
** $Id: QExGeoDrawHelper.cxx,v 1.3.4.1 2016/05/23 18:32:53 jeromel Exp $
**
...
#if  ROOT_VERSION_CODE >= ROOT_VERSION(5,03,0)
   virtual void    SetPoints(Double_t *buff) const { ((TARB8*)this)->SetPoints(buff); }
#endif   
