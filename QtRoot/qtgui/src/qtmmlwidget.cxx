...
/*!
    Sets the default foreground color \a color of the font used to render expressions

    \sa setbaseFontPointSize() fontName() setFontName()
*/
void QtMmlWidget::setForegroundColor(const QColor &color)
{
...
/*!
    ...
    \sa setbaseFontPointSize() fontName() setFontName()
*/
void QtMmlDocument::setForegroundColor(const QColor &color)
{
    m_doc->setForegroundColor(color);
}
