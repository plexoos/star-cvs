// @(#)root/ged:$Name:  $:$Id: TQtGedAttFrame.h,v 1.4.4.1 2016/05/23 18:32:55 jeromel Exp $
...
public:
   ...
   virtual QDockWindow *Dock()    const     = 0;
...
//_________________________________________________________________________________________________________
 ...
 protected:
   ...
   virtual QDockWindow *Dock() const { return (QDockWindow *)this; }
