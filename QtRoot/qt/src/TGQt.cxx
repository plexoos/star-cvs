// @(#)root/qt:$Name:  $:$Id: TGQt.cxx,v 1.26 2008/04/14 02:35:03 fine Exp $
// Author: Valeri Fine   21/01/2002
/****************************************************************************
** $Id: TGQt.cxx,v 1.26 2008/04/14 02:35:03 fine Exp $
**
...
Bool_t TGQt::Init(void* /*display*/)
{
   ...
   //*-*                        ========================                      *-*
   fprintf(stderr,"** $Id: TGQt.cxx,v 1.26 2008/04/14 02:35:03 fine Exp $ this=%p\n",this);
#if QT_VERSION >= 0x40000
#ifndef R__QTWIN32
...
void TGQt::CopyPixmap(const QPixmap &src, Int_t xpos, Int_t ypos)
{
   ...
   if (fSelectedWindow )
   {
      ...
      {
        QPainter paint(dst);
        // setCompistion makes sense for QImage only
