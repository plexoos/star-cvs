...
%
% $Id: StarClassLibrary.tex,v 1.24 2009/08/04 23:16:51 fine Exp $
%
...
% Revision 1.24  2009/08/04 23:16:51  fine
...
\begin{center}
  ...
  {\LARGE $ $Revision: 1.24 $ $}  \\[5mm] % replaced by cvs with current revision  
  {\LARGE $ $Date: 2009/08/04 23:16:51 $ $}  % replaced by cvs with current revision  
  \vfill
\end{center}
\cleardoublepage
\end{titlepage}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%    Reference: StHelixHelper
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{StHelixHelper \index{StHelixHelper|textbf}}
\index{StHelixHelper}
\index{StHelixHelper}
\begin{Entry}
\item[Summary]
...
\item[Synopsis]
    \verb+#include "StHelixHelper.h"+ \\
    \verb+StHelixHelper helper;+
    
\item[Description]    
    This class  is to convert the object represented by  2 \ref{StPhysicalHelixD} 
    (for example STAR \verb+StTrack+ / \verb+StMuTrack+ objects) into the plain array of the 
    3D coordinates to satisfy the various plotting / visualization needs.
...
\item[Public\\ Constructors]
    \verb+StHelixHelper(const StPhysicalHelix &helix
...
\item[Public Member\\ Functions]
    ...
    \verb+ Float_t  *GetPoints(int &npoints)     const+\\
    Creates the Float_t array of the npoints 3D coordinates
    The end-use code is repsonsible to destroy the output array 
    to free the memory via \verb+delete []+\\ C++ statement.
 
\item[Example]
{\footnotesize
\begin{verbatim}
#include "StHelixHelper.hh"

int main()
{   
    StHelixHelper timer, totalTimer;
