...
%
% $Id: StarClassLibrary.tex,v 1.16 2000/03/06 19:23:40 ullrich Exp $
%
...
\begin{center}
  ...
  {\LARGE $ $Revision: 1.16 $ $}  \\[5mm] % replaced by cvs with current revision  
  {\LARGE $ $Date: 2000/03/06 19:23:40 $ $}  % replaced by cvs with current revision  
  \vfill
\end{center}
\cleardoublepage
\end{titlepage}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{StFastCircleFitter \index{StFastCircleFitter}} \label{StFastCircleFitter}
\index{circle fit}
\begin{Entry}
\item[Summary]
...
\begin{eqnarray}
    ...
    y(s) & = & y_0 + s \cos\lambda \cos\Phi_0 \\
