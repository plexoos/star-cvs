...
%
% $Id: StEvent.tex,v 2.64 2001/10/01 20:02:21 ullrich Exp $
%
...
\begin{center}
  ...
  {\LARGE $ $Revision: 2.64 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2001/10/01 20:02:21 $ $}  % replaced by cvs with current revision
  \vfill
\end{center}
\cleardoublepage
\end{titlepage}
