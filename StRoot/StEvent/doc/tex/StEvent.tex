...
%
% $Id: StEvent.tex,v 2.38 2000/06/07 09:44:20 ullrich Exp $
%
...
\vspace*{-35mm}
  ...
  {\end{list}}
  {\LARGE $ $Revision: 2.38 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/06/07 09:44:20 $ $}  % replaced by cvs with current revision
