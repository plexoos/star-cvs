...
%
% $Id: StEvent.tex,v 2.39 2000/06/21 22:55:42 ullrich Exp $
%
...
\vspace*{-35mm}
  ...
  {\end{list}}
  {\LARGE $ $Revision: 2.39 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/06/21 22:55:42 $ $}  % replaced by cvs with current revision
