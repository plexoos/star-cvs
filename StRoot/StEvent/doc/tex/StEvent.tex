...
%
% $Id: StEvent.tex,v 2.32 2000/05/17 17:20:01 ullrich Exp $
%
...
\newcommand{\entrylabel}[1]{\mbox{\textbf{{#1}}}\hfil}%
  {\LARGE $ $Revision: 2.32 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/05/17 17:20:01 $ $}  % replaced by cvs with current revision
...
\item[Synopsis]
    ...
    \verb+class StRichPixelCollection;+\\
\item[Description]
\item[Related Classes]
\item[Public\\ Constructors]
