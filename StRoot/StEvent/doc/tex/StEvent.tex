...
%
% $Id: StEvent.tex,v 2.43 2000/08/17 01:18:02 ullrich Exp $
%
...
\begin{document}
  {\LARGE $ $Revision: 2.43 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/08/17 01:18:02 $ $}  % replaced by cvs with current revision
%
%    Title page
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
