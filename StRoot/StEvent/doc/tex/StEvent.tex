...
%
% $Id: StEvent.tex,v 2.42 2000/07/13 12:47:07 ullrich Exp $
%
...
{\renewcommand{\entrylabel}{\Entrylabel}\begin{entry}}%
  {\LARGE $ $Revision: 2.42 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/07/13 12:47:07 $ $}  % replaced by cvs with current revision
\begin{document}
  {\LARGE $ $Revision: 2.42 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/07/13 12:47:07 $ $}  % replaced by cvs with current revision
%
