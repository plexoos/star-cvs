...
%
% $Id: StEvent.tex,v 2.36 2000/06/01 16:46:23 ullrich Exp $
%
...
\vspace*{-35mm}
  ...
  {\end{list}}
  {\LARGE $ $Revision: 2.36 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/06/01 16:46:23 $ $}  % replaced by cvs with current revision
