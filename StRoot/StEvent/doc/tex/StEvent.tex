...
%
% $Id: StEvent.tex,v 2.44 2000/08/17 00:36:31 ullrich Exp $
%
...
\begin{document}
  {\LARGE $ $Revision: 2.44 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/08/17 00:36:31 $ $}  % replaced by cvs with current revision
%
%    Title page
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
