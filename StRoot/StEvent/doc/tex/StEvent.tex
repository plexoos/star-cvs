...
%
% $Id: StEvent.tex,v 2.35 2000/05/31 14:26:26 lasiuk Exp $
%
...
\vspace*{-35mm}
  ...
  {\end{list}}
  {\LARGE $ $Revision: 2.35 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/05/31 14:26:26 $ $}  % replaced by cvs with current revision
