...
%
% $Id: StEvent.tex,v 2.78 2003/05/21 19:10:22 ullrich Exp $
%
...
\begin{center}
  ...
  {\LARGE $ $Revision: 2.78 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2003/05/21 19:10:22 $ $}  % replaced by cvs with current revision
  \vfill
\end{center}
\cleardoublepage
\end{titlepage}
...
\item[Public Member\\ Functions]
    \verb+const StSPtrVecTofCell& tofCell() const;+\\
    \verb+StSPtrVecTofCell& tofCell();+\\
    \verb+const StSPtrVecTofSlat& tofSlat() const;+\\
    \verb+StSPtrVecTofSlat& tofSlat();+\\
