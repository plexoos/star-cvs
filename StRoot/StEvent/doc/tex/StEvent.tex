...
%
% $Id: StEvent.tex,v 2.33 2000/05/22 22:04:07 ullrich Exp $
%
...
\newcommand{\entrylabel}[1]{\mbox{\textbf{{#1}}}\hfil}%
  {\LARGE $ $Revision: 2.33 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/05/22 22:04:07 $ $}  % replaced by cvs with current revision
