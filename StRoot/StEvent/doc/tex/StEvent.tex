...
%
% $Id: StEvent.tex,v 2.37 2000/06/01 21:36:17 ullrich Exp $
%
...
\vspace*{-35mm}
  ...
  {\end{list}}
  {\LARGE $ $Revision: 2.37 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/06/01 21:36:17 $ $}  % replaced by cvs with current revision
