...
%
% $Id: StEvent.tex,v 2.74 2003/01/28 20:50:05 ullrich Exp $
%
...
\begin{center}
  ...
  {\LARGE $ $Revision: 2.74 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2003/01/28 20:50:05 $ $}  % replaced by cvs with current revision
  \vfill
\end{center}
\cleardoublepage
\end{titlepage}
