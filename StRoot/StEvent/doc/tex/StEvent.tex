...
%
% $Id: StEvent.tex,v 2.40 2000/06/22 18:18:33 ullrich Exp $
%
...
{\renewcommand{\entrylabel}{\Entrylabel}\begin{entry}}%
  {\LARGE $ $Revision: 2.40 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/06/22 18:18:33 $ $}  % replaced by cvs with current revision
\begin{document}
  {\LARGE $ $Revision: 2.40 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/06/22 18:18:33 $ $}  % replaced by cvs with current revision
%
