...
%
% $Id: StEvent.tex,v 2.56 2001/03/14 03:05:33 ullrich Exp $
%
...
\begin{center}
  ...
  {\LARGE $ $Revision: 2.56 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2001/03/14 03:05:33 $ $}  % replaced by cvs with current revision
  \vfill
\end{center}
\cleardoublepage
\end{titlepage}
...
\item[Public Member\\ Functions]
    ...
    \verb+StSPtrVecPsd* psds();+\\
    \verb+const StSPtrVecPsd* psds() const;+\\
    Returns vector containing all PSDs or \texttt{null} if no PSD is available.
...
\item[Public Member\\ Functions]
    ...
    \item unattenuated signals (mostly useful for looking at the single neutron peak)
        ...
        \item adc[6] = zdcEast2;     
        \item adc[5] = zdcEast3;     
        \item adc[4] = zdcEastSum;   
        \item adc[3] = zdcWest1;     
        \item adc[2] = zdcWest2;     
        \item adc[1] = zdcWest3;     
        \item adc[0] = zdcWestSum;   
        \end{description}
    \item attenuated signals
        \begin{description}
        \item adc[10] = zdcWestSumAtt; 
        \item adc[11] = zdcWest2Att; 
        \item adc[12] = zdcWest1Att;    
